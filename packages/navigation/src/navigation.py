...
class speed_publisher(object):
    ...
    def __init__(self, robot_name, town):
        ...
        self.pub_wheels_cmd = rospy.Publisher("/" + str(robot_name) + "/cmd_vel", Twist, queue_size=1)
        ...
        if town == "small_duckietown":
            self.trajectory = [(3.61, 1.54), (8.43, 3.69), (8.39, 8.89), (-1.62, 10.27), (-5.80, 16.21),
                               (-13.03, 16.21), (-24.84, 16.21), (-30.08, 13.99), (-30.08, 6.73), (-29.31, 2.4),
                               (-20.56, 1.50), (-15.16, 3.19), (-15.16, 11.09), (-14.19, 13.66), (-8.35, 13.66),
                               (-4.98, 8.38), (3.27, 7.3), (5.94, 5.97), (3.90, 4.32), (-13.02, 4.32), (-24.69, 4.32),
                               (-26.78, 5.94), (-26.78, 11.33), (-25.30, 13.62), (-20.41, 13.62), (-18.09, 12.43),
    ...
    def getCloserTrajPoint(self):
        ...
        try:
            ...
            print
            "Initial pos of the robot is (" + str(x) + "," + str(y) + ")"
        ...
        print
        "Closer trajectory point to duckiebot " + str(self.this_robot) + " is " + str(
            point) + " which is the trajectory point number " + str(ntraj)
        return point, ntraj
    ...
    def getNextOrientation(self):
        ...
        try:
            ...
            (r, p, y) = tf.transformations.euler_from_quaternion(
                [dxy.pose.orientation.x, dxy.pose.orientation.y, dxy.pose.orientation.z, dxy.pose.orientation.w])
            ...
            if dist < 1.0:
                ...
                print
                "\n SELECTED next traj point for duckiebot " + str(self.this_robot) + " is " + str(
                    self.NextTrajPoint) + "\n"
    ...
    def publishSpeedMsg(self):
        ...
        twist = Twist()
        twist.linear.x = baseSpeed
        twist.angular.z = -incVel
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        print("usage: navigation.py <robot_name>")
    else:
        # Get this robot name
